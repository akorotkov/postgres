...
DATA(insert OID = 5033 (  vodka		0 6 f f f f t t f f t f f 0 vodkainsert vodkabeginscan - vodkagetbitmap vodkarescan vodkaendscan vodkamarkpos vodkarestrpos vodkabuild vodkabuildempty vodkabulkdelete vodkavacuumcleanup - gincostestimate vodkaoptions ));
